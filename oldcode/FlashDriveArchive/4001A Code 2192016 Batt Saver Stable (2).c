...
task basicflywheel()
{
	...
	if(vexRT[Btn8U]==1)
	{
		motor(Leftflywheel) = 54;
		motor(Rightflywheel) = 54;
	}

	else if (vexRT[Btn8U]==1 && vexRT[Btn8R]==1)
	{
		motor(Leftflywheel) = 51;
		motor(Rightflywheel) = 51;

	}

	else if(vexRT[Btn8R]==1)
	{
		motor(Leftflywheel) = 49;
		motor(Rightflywheel) = 49;
	}

	else if(vexRT[Btn8L]==1)
	{
		motor(Leftflywheel) = 45;
		motor(Rightflywheel) = 45;
	}
