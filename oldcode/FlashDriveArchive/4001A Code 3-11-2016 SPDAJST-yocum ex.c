...
task autonomous()
{
	startMotor(Leftflywheel, 58);//Start flywheels up to speed
	startMotor(Rightflywheel, 58);//Start flywheels up to speed
	wait(3.75);//Start flywheels up to speed wait for 1st ball
	startMotor(Intake, 100);//Load first ball
	wait(.5);//Launch 1
	stopMotor(Intake);
	startMotor(Leftflywheel, 51);//Start flywheels up to speed
	startMotor(Rightflywheel, 51);//Start flywheels up to speed
