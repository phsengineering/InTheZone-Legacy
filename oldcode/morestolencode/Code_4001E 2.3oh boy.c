...
void autonomousexe() ////Autonomous is in a void to ease calling it to action
{
	...
	{///////////ENCODERSTUFF
		...
		if(SensorValue(in8)>3900)///////If the arm is LOWER than
		{
			motor[Leftarm] = -20;
	...
	motor(claw) = -100; ////CLOSE CLAW SPEED
	motor(claw2) = -100;
	wait(0.05);


	motor(Leftside) = 127;/////JERK to drop/////
	motor(Rightside) = 127;
	wait(0.05);
	...
	motor[Leftarm] = -70; //////This lifts arm so arm does not immediantly hit floor//// //bottom left
	motor[Rightarm] = 70;
	...
	motor(Rightside) = -127;
	wait(.2);
	motor[port6] = -50; //bottom left
	motor[port9]= 50; //bottom right
	wait(.5);
	motor[Leftarm] = 0;
	motor[Rightarm] = 0;
	...
	motor[Leftarm] = -127; /////////SCORE THE STARS//LENGTH: 1.4 Secs///////////
	motor[port6] = -127;
	motor[Rightarm] = 127; ////speed at which the arm dumps stars
	motor[port9]= 127;
