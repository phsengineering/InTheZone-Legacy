...
#pragma config(Motor,  port6,           liftMotorLeft, tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port7,           liftMotorRight, tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port8,           clawMotor,     tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port9,           mogoLift,      tmotorServoContinuousRotation, openLoop)
...
task autonomous() {
	motor[liftMotorLeft] = 63; //bring up the lift system motor
	motor[liftMotorRight] = 63; //bring up the lift system motor
	wait(1);
...
task usercontrol()
{
	...
	while( true )
	{
		wait1Msec( 100 );
		startTask(clawControl);
		motor[liftMotorLeft] = vexRT[Ch2Xmtr2]; //run the two lift system motors off of channel 2 input
		motor[liftMotorRight] = vexRT[Ch3Xmtr2]; //run the other two lift system motors off of channel 3 input
		motor[mogoLift] = -vexRT[Ch2];
	}
}
