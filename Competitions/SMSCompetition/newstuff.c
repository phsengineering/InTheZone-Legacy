...
#pragma config(Motor,  port7,           armManuever,   tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port8,           clawMotor,     tmotorVex393TurboSpeed_MC29, openLoop)
...
task liftControl() {
while(true) {
	motor[armManuever] = vexRT[Ch3Xmtr2]/2; //get input from the right side controller joystick and assign it to the left side arm
